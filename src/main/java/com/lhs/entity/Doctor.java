...
//	}
//	@OneToOne
//	private AppointmentTable details;
	...
	public String toString() {
		return "Doctor [id=" + id + ", name=" + doctorName + ", specialist=" + specialist + ", availableTime=" + availableTime
				+ ", unavailable=" + unavailable + ", feedback=" + feedback + ", rating=" + rating + ", city=" + city
				+ ", doctorFee=" + doctorFee + ", state=" + state + ", appointmentStartTime=" + appointmentStartTime
