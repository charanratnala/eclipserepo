...
public class AppointmentController {
	...
	public ResponseEntity<String> addDoctor(@RequestBody SlotEntity slotEntity,@RequestBody Doctor doctor) {
		if (doctor == null) {
...
//			  
	...
	@PutMapping("/slotupgrade")
	void upgradSlot(@RequestBody SlotEntity slotEntity)
	{
